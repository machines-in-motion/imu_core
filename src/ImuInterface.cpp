...
#include "imu-ros-rt/ImuInterface.h"
  ...
  bool ImuInterface::initialize(uint8_t* message_type, int num_messages) {
    ...
    // // start IMU reading thread
     ...
     imu_comm_thread_.reset(new boost::thread(boost::bind(&ImuInterface::readingLoop, this)));

    return true;
  }

  bool ImuInterface::setStreamThreadParams(char* keyword, int priority, int stacksize, int cpu_id, int delay_ns) {
  ...
  bool ImuInterface::openPort(void) {
  ...
  bool ImuInterface::switchMode(bool to_25) {
  ...
  bool ImuInterface::setCommunicationSettings(void) {
  ...
  bool ImuInterface::setSamplingSettings(void) {
  ...
  bool ImuInterface::initTimestamp(void) {
  ...
  bool ImuInterface::startStream(void) {
  ...
  bool ImuInterface::stopStream(void) {
  ...
  bool ImuInterface::closePort(void) {
  ...
  bool ImuInterface::stopReadingLoop(void) {
  ...
  bool ImuInterface::receiveStabAccelAngrateMag(void) {
  ...
  bool ImuInterface::receiveAccelAngrateOrient(void) {
  ...
  bool ImuInterface::receiveQuat(void) {
  ...
  bool ImuInterface::readAccelAngrate(double* accel, double* angrate, double& timestamp) {
  ...
  bool ImuInterface::readStabAccelAngrateMag(double* stab_accel, double* angrate, double* stab_mag, double& timestamp) {
  ...
  bool ImuInterface::readQuat(double* quat, double& timestamp) {
  ...
  uint16_t ImuInterface::bswap_16(uint16_t x) {
    return (x>>8) | (x<<8);
  }

  uint32_t ImuInterface::bswap_32(uint32_t x) {
  ...
  // NOT CURRENTLY USED:
  bool ImuInterface::readMisalignedMsgFromDevice(uint8_t cmd, int len) {
...
/////////////// C interface //////////                                                                  
ImuInterface myIMU("ttyACM0",true,false,false);
extern "C"
{
